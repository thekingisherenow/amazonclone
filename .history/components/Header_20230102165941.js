  ...
  return (
    <div>
      ...
      <div className='bg-amazon flex h-16'>
        ...
        {/* //SIGN IN -LAPTOP. */}
          <div onMouseEnter={()=>setSigninOpen(true)} onMouseLeave={()=>setSigninOpen(false)}
           className='hidden sm:inline-flex link  flex-col p-2 '>
          ...
          {signinOpen && <div className='absolute z-50 top-5 right-10'>
            Heyy
