        ...
        {/* //SIGN IN -LAPTOP. */}
          ...
          onMouseEnter={()=>setSigninOpen(true)} onMouseLeave={()=>setSigninOpen(false)}
           className='hidden sm:inline-flex link  flex-col p-2 relative '>
            ...
            {signinOpen && <div className='absolute z-50 -inset-12 top-12 text-black bg-white w-72 h-52 items-center grid grid-cols-2
            '>
                <div className='col-span-2 text-center h-12'>
