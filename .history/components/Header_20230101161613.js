  ...
  return (
    <div>
      ...
      <div className='bg-amazon flex '>
        <div className='flex items-center text-white h-11'>
        ...
        <p className='hover:border-2 hover:border-white px-2  link'>Today's Deals</p>
        <p className='hover:border-2 hover:border-white px-2  link'>Customer Service</p>
        <p className='hover:border-2 hover:border-white px-2  link'>Gift Cards</p>
        <p className='hover:border-2 hover:border-white px-2  link'>Registry</p>
        <p className='hover:border-2 hover:border-white px-2  link'>Sell</p>
        </div>
        <div className='flex justify-end ml-auto items-center'>

        <p className='  text-white link hover:border-2 hover:border-white px-2  link '>Shop deals in Electronics</p>
        </div>
      </div>
