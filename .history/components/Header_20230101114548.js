      ...
      <div className='bg-amazon flex text-w'>
        ...
        {/* FAVICON */}
          ...
          <div className='link flex  p-2 items-center '>
            ...
            <span className='absolute top-0 right-1 bg-black text-orange-700 font-extrabold text-2xl rounded-full h-3 w-3 flex justify-center items-center p-3' >0</span>
            </div>
