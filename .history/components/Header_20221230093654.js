    ...
    <div>
      ...
      <div className='bg-amazon flex text-w'>
        ...
        {/* FAVICON */}
          ...
          <div className='flex text-sm items-center text-white space-x-10 whitespace-nowrap'>

            <div className='cursor-pointer flex flex-col p-2 hover:border hover:border-white'>
              <p>Hello,sign in</p>
              <span className='flex'>
          ...
          <div className='cursor-pointer flex hover:border hover:border-white p-2 items-center'>
