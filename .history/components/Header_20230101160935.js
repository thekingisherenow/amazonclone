  ...
  return (
    <div>
      ...
      <div className='bg-amazon h-12 flex items-center text-white'>
        ...
        <p className='hover:border-2 hover:border-white px-2 py-1 link'>Today's Deals</p>
        <p className='hover:border-2 hover:border-white px-2 py-1 link'>Customer Service</p>
        <p className='hover:border-2 hover:border-white px-2 py-1 link'>Gift Cards</p>
        <p className='hover:border-2 hover:border-white px-2 py-1 link'>Registry</p>
        <p className='hover:border-2 hover:border-white px-2 py-1 link'>Sell</p>
      </div>
    </div>
  )
}
