  ...
  return (
    <div>
      ...
      <div className='bg-amazon h-12 flex items-center text-white space-x-3'>
        ...
        <p className='hover:border-2 hover:border-white'>Today's Deals</p>
        <p className='hover:border-2 hover:border-white'>Customer Service</p>
        <p className='hover:border-2 hover:border-white'>Gift Cards</p>
        <p className='hover:border-2 hover:border-white'>Registry</p>
        <p className='hover:border-2 hover:border-white'>Sell</p>
      </div>
    </div>
  )
}
