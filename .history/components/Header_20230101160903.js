    ...
    <div>
      ...
      <div className='bg-amazon h-12 flex items-center text-white'>
        <p className='text-white flex hover:border-2 hover:border-white'>
          ...
          <span className='m-1 font-bold'> All</span>
        </p>
        <p className='hover:border-2 hover:border-white p-2 link'>Today's Deals</p>
        <p className='hover:border-2 hover:border-white p-2 link'>Customer Service</p>
        <p className='hover:border-2 hover:border-white p-2 link'>Gift Cards</p>
        <p className='hover:border-2 hover:border-white p-2 link'>Registry</p>
        <p className='hover:border-2 hover:border-white p-2 link'>Sell</p>
      </div>
    </div>
  )
}
