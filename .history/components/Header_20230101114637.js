      ...
      <div className='bg-amazon flex text-w'>
        ...
        {/* FAVICON */}
          ...
          <div className='link flex  p-2 items-center '>
            ...
            <span className='absolute top-[5px] right-1 bg-black text-orange-500 font-extrabold text-md rounded-full h-3 w-3 flex justify-center items-center p-3' >0</span>
            </div>
