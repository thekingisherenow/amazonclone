    ...
    <div>
      ...
      <div className='bg-amazon flex flex-col md:flex-row '>
        <div className='flex'>
          ...
          <div className='flex lg:hidden justify-end items-center text-white items-center ml-auto'>
            <div className='flex h-10'>
                <p className='text-sm'>Sign in</p>
                <ChevronRightIcon className='w-2 h-3 items-center mt-1'/>
        ...
        <div className='hidden md:inline-flex justify-end ml-auto text-sm items-center text-white space-x-1 whitespace-nowrap mr-3'>
          ...
          <div
            ...
            {/* 
            POPOVERS */}
            {signinOpen && <div className='absolute z-50 truncate cursor-default shadow-xl  border-gray-600 -inset-44 top-12 text-black bg-white w-[500px] h-80 items-center grid grid-cols-2
            '>
