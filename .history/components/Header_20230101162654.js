  ...
  return (
    <div>
      ...
      <div className='bg-amazon flex h-16'>
        ...
        <div className='flex justify-end text-sm items-center text-white space-x-1 whitespace-nowrap mr-3'>
      ...
      <div className='bg-amazon flex '>
        ...
        <p className=' px-2  link'>Gift Cards</p>
        <p className=' px-2  link'>Registry</p>
