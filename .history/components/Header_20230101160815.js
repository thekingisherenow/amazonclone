...
function Header() {
  return (
    <div>
      ...
      {/* BOTTOM NAV */}
      <div className='bg-amazon h-12 flex items-center text-white space-x-3'>
        ...
        <p className='hover:border-2 hover:border-white p-1 link'>Today's Deals</p>
        <p className='hover:border-2 hover:border-white p-1 link'>Customer Service</p>
        <p className='hover:border-2 hover:border-white p-1 link'>Gift Cards</p>
        <p className='hover:border-2 hover:border-white p-1 link'>Registry</p>
        <p className='hover:border-2 hover:border-white p-1 link'>Sell</p>
      </div>
    </div>
  )
}
