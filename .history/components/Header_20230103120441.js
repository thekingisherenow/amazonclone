      ...
      <div className='bg-amazon flex h-16'>
        ...
        <div className='flex justify-end ml-auto text-sm items-center text-white space-x-1 whitespace-nowrap mr-3'>
          ...
          <div 
            ...
            {/* 
            POPOVERS */}
            {signinOpen && <div className='absolute z-50 truncate cursor-default shadow-xl border-2 border-gray-600 -inset-44 top-12 text-black bg-white w-[500px] h-80 items-center grid grid-cols-2
            '>
