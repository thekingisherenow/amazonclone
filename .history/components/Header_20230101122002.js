      ...
      <div className='bg-amazon flex text-w'>
        ...
        {/* FAVICON */}
            ...
            {/* SEARCH  */}
              ...
              <div className='m-3 bg-white rounded-xl flex-grow '>
          ...
          <div className='flex text-sm items-center text-white space-x-5 whitespace-nowrap'>
          ...
          <div className='link flex  p-2 items-center mr-5 pr-5 '>
