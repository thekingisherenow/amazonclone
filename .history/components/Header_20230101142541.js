      ...
      <div className='bg-amazon flex h-15'>
        ...
        {/* FAVICON */}
            ...
            {/* SEARCH  */}
              ...
              <div className='m-1 mt-3 flex bg-white rounded-xl flex-grow h-12'>

              <input  className='p-2 h-full flex-grow bg-red-600 focus:outline-none px-4' type="text" />

              <MagnifyingGlassIcon className=' h-8 font-bold bg-orange-400 w-10 flex items-center justify-center' />
              </div>
